<?php
    ...
    if($item->atualizarContaPagar($ambiente_caixa_logado)){
        echo json_encode("Dados da Conta a Pagar atualizados.");
    } else{
        echo json_encode("Dados do Conta a Pagar não foram atualizados");
    }
?>