<?php
    ...
    $item->contareceber_caixa_id = $ambiente_caixa_logado;
    ...
    if($item->criarContaReceber($ambiente_caixa_logado)){
        echo 'Conta a Receber criada com sucesso.';
    } else{
        echo 'Conta a Receber não pode ser criada.';
    }
?>